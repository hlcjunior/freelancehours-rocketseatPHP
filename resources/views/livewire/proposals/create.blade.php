        ...
        <form class="flex flex-col gap-6" wire:submit="save">
            ...
            <div class="flex gap-4">
                <div class="w-2/3 gap-2 flex flex-col">
                    ...
                    />
                    @error('email') <span class="text-red-600 mt-1 text-sm">{{ $message }}</span> @enderror
                </div>
                <div class="w-1/3 gap-2 flex flex-col">
                    ...
                    <div class="flex" x-data="{ hours: @entangle('hours') }">
                        <button type="button" class="bg-[#1E1E2C] hover:bg-[#313145] transition duration-300 ease-in-out
                        text-[#C3C3D1] py-2 px-3 text-3xl"
                                @click="hours--">-
                        </button>
                    ...
                    @error('hours') <span class="text-red-600 mt-1 text-sm">{{ $message }}</span> @enderror
                </div>
            </div>
            <div>
                <label for="agree"
                ...
                @error('agree') <span class="text-red-600 mt-1 text-sm">{{ $message }}</span> @enderror
            </div>
            <button class="bg-[#5354FD] text-white font-bold tracking-wide uppercase px-8 py-3 rounded-[4px]
